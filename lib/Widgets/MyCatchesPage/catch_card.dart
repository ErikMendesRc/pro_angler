...
class CatchCard extends StatelessWidget {
  final String catchId; // Adicionado o ID da captura
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.pushNamed(context, '/catchdetails', arguments: catchId);
        },
        child: Card(
              ...
              Padding(
                ...
                child: Text(
                  validatedBy == 'Aguardando...'
                      ...
                      : 'Juiz: $validatedBy',
                  style: TextStyle(
                    color: validatedBy == 'Aguardando...' ? Colors.green : CoresPersonalizada.white,
                  ),
                ),
              ),
            ],
